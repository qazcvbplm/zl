package com.dingdian.order.ui.widget.printutil;
...
public abstract class PrinterWriter {
     ...
     */
    @SuppressWarnings("unused")
    public void doubleHeightWidthOff() throws IOException {
        write(PrinterUtils.doubleHeightWidthOff());
    }
     ...
     */
    @SuppressWarnings("unused")
    public void doubleHeightWidthOn() throws IOException {
        write(PrinterUtils.doubleHeightWidthOn());
    }
    ...
    public void printStringOtherLine(String str)throws IOException{
        int length = getLineWidth();
        int strLength = getStringWidth(str);
        String line = "";
        int half = (length - strLength) /2;
        int temp = 0;
        while (temp<=half){
            line += "- ";
            temp++;
