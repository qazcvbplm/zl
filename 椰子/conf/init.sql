...
CREATE TABLE `charge` (
  ...
  `is_delete` int(11) NOT NULL DEFAULT '0' COMMENT '是否删除',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='充值项';
...
CREATE TABLE `day_log_takeout` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=434 DEFAULT CHARSET=utf8 COMMENT='日记录';
...
CREATE TABLE `full_cut` (
  ...
  PRIMARY KEY (`Id`),
  KEY `index` (`shop_id`)
) ENGINE=InnoDB AUTO_INCREMENT=384 DEFAULT CHARSET=utf8 COMMENT='满减列表';
...
) ENGINE=InnoDB AUTO_INCREMENT=107 DEFAULT CHARSET=utf8 COMMENT='订单商品';
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='订单结算';
...
) ENGINE=InnoDB AUTO_INCREMENT=860 DEFAULT CHARSET=utf8 COMMENT='配送员';
...
CREATE TABLE `shop` (
  ...
  `shop_code_image` varchar(100) CHARACTER SET utf8mb4 DEFAULT '' COMMENT '店铺二维码图片',
  `print_type` int(4) DEFAULT NULL COMMENT '店铺打印类型，默认0（蓝牙打印）0-蓝牙打印 1-GPRS打印',
  PRIMARY KEY (`Id`)
...
CREATE TABLE `shop_category` (
  ...
  `school_id` int(11) NOT NULL DEFAULT '0' COMMENT '学校id',
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8 COMMENT='店铺分类';
...
) ENGINE=InnoDB AUTO_INCREMENT=116 DEFAULT CHARSET=utf8 COMMENT='店铺优惠券关联表';
...
CREATE TABLE `shop_print` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键id',
  `shop_id` bigint(20) NOT NULL COMMENT '店铺id',
  `print_brand` int(4) NOT NULL COMMENT '打印机品牌 1-飞鹅，2-飞印，3-其他',
  ...
  PRIMARY KEY (`id`),
  KEY `normal_index_shop_id` (`shop_id`) USING BTREE COMMENT '店铺id索引'
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COMMENT='店铺打印机表';
...
CREATE TABLE `sign` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=22756 DEFAULT CHARSET=utf8 COMMENT='签到表';
...
CREATE TABLE `tx_log` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='提现日志';
...
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='微信用户';
...
CREATE TABLE `wx_user_coupon` (
  ...
  KEY `normal_index_coupon_id` (`coupon_id`) USING BTREE COMMENT '优惠券id索引'
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='用户优惠券关联表';
